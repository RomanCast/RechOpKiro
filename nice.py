...
print('cout depart')
print(cout_architecture(architecture_depart, DistancesNice))
reseau1 = architecture_depart.pop(0)
reseau2 = architecture_depart.pop(0)
reseau3 = architecture_depart.pop(0)
test1 = descente_rap_boucle(reseau1, DistancesNice, 100000)
test2 = descente_rap_boucle(reseau2, DistancesNice, 100000)
test3 = descente_rap_boucle(reseau3, DistancesNice, 100000)
architecture_arrivee = [test1] + [test2] + [test3]
#architecture = [test1] + [test2] + [test3]
print('cout arrivee')
print(cout_architecture(architecture_arrivee, DistancesNice))

write_solution(architecture_arrivee, nbDistribution, 'nice')
