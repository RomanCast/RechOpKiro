...
# test1 = descente_rap_reseau(reseau1, DistancesPim, 10000)
# test2 = descente_rap_boucle(reseau2, DistancesPim, 10000)
# test3 = descente_rap_boucle(reseau3, DistancesPim, 10000)
# test4 = descente_rap_boucle(reseau4, DistancesPim, 10000)
# test5 = descente_rap_boucle(reseau5, DistancesPim, 10000)
# test6 = descente_rap_boucle(reseau6, DistancesPim, 10000)
# test7 = descente_rap_boucle(reseau7, DistancesPim, 10000)
# test8 = descente_rap_boucle(reseau8, DistancesPim, 10000)
# test9 = descente_rap_boucle(reseau9, DistancesPim, 10000)
# test10 = descente_rap_boucle(reseau10, DistancesPim, 10000)
# test11 = descente_rap_boucle(reseau11, DistancesPim, 10000)
...
print('cout depart')
print(cout_architecture(architecture_depart, DistancesPim))
...
test1 = descente_rap_reseau(reseau1, DistancesPim, 100000)
test2 = descente_rap_boucle(reseau2, DistancesPim, 10000)
test3 = descente_rap_boucle(reseau3, DistancesPim, 10000)
test4 = descente_rap_boucle(reseau4, DistancesPim, 10000)
test5 = descente_rap_boucle(reseau5, DistancesPim, 10000)
...
print('cout arrivee')
print(cout_architecture(architecture_arrivee, DistancesPim))

write_solution(architecture_arrivee, nbDistribution, 'pim')
